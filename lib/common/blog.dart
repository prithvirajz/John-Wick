              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: Image.asset(
                    "assets/john_blog2.jpg",
                    filterQuality: FilterQuality.high,
                    fit: BoxFit.cover,
                  ),
                ),
                expandedHeight: isWeb ? 600.0 : 500.0,
              )
            ];
          },
...
class BlogPost extends StatefulWidget {
  ...
  final body;
  final isWeb;
  const BlogPost({Key? key, this.title, this.body, @required this.isWeb})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: widget.isWeb
          ? EdgeInsets.only(left: 70.0, top: 40.0, right: 70.0)
